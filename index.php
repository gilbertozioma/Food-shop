        ...
        <div class="container-fluid">
            ...
            <div class=" collapse navbar-collapse text-light" id="navbarSupportedContent" class="text-light">
                <ul class="navbar-nav ul-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link text-light" href="#heroSlider">Home</a>
                    </li>
                    <li class="nav-item">
    ...
    <section id="about">
        <div class="container">
            <div class="row gy-4 align-items-center">
                <div class="col-lg-5">
                    <img src="./admin/product_images/view.jpeg" alt="image">
                </div>
                <div class="col-lg-5">
                    <h1>About us</h1>
                    <div class="divider my-4"></div>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugit necessitatibus dolor nesciunt reprehenderit a, explicabo nihil.</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor architecto eaque, saepe totam beatae nam aliquid. Quas animi explicabo veniam illum quaerat.</p>
                    <a href="#menu" class="btn rounded-0 text-light bg">Explore Menu</a>
                </div>
            </div>
        </div>
    </section>
