...
<body class="bg-light">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg nav-bg sticky-top shadow py-2">
                ...
                <div class="row m-2">
                    <div class="me-2 text-light">
                        ...
                        if (isset($_SESSION['username'])) {
                            echo "<div>
                                    <a class='nav-link text-light' href='profile.php'><i class='fa-solid fa-user'></i></a>
                                </div>";
                        } else {
                            echo "<div'>
    ...
    <!-- Third Child -->
    <div class="bg-secondary p-3 third-div">
        <h2 class="text-center text-light h3-food pt-2">Food Shop</h2>
    ...
    <div class="row">
        <div class="col-md-2 p-0">
            <ul class="navbar-nav h-100 bg-secondary text-center">
